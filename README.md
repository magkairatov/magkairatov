...
* Построение event-driven архитектур на базе Apache Kafka и Akka Streams
* Интеграция корпоративных систем (Oracle AQ, Cassandra, KSQL)
* Создание real-time аналитических дашбордов в Power BI
* Автоматизация бизнес-процессов через VBA и PL/SQL

## 🛠 Технологический стек

**Потоковая обработка данных:**
* Apache Kafka, KSQL, Kafka Streams
* Akka Streams, Akka HTTP, Akka Cluster
* Alpakka (Kafka, Cassandra, JMS коннекторы)
...
* Power BI
* Построение real-time дашбордов
...
* **Интеграции:** Way4, DWH, множественные Kafka топики

## 🎓 Экспертиза

* ✅ Реактивное программирование (Akka, Reactive Streams)
* ✅ Распределенные системы и микросервисная архитектура
* ✅ Event-driven design patterns
* ✅ Stream processing и real-time аналитика
...
**Data Engineer** | Банковский сектор | Алматы
* Разработка систем потоковой обработки транзакций
* Интеграция с Oracle, Cassandra, Kafka
* Построение аналитических дашбордов в Power BI
* Автоматизация процессов через PL/SQL и VBA
* Оптимизация производительности KSQL запросов

## 🌟 Дополнительно

* Глубокое понимание паттернов корпоративной интеграции (EIP)
